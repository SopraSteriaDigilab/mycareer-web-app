...
function initDevelopmentNeeds(){
	...
	getDevelopmentNeedsListNEW(ADLoginID);
  ...
  //onClick for Close modal
    ...
    $('#delete').click(function(){ deleteDevelopmentNeed(ADLoginID, $("#delete-id").text(), $("#deleteTitle").text(), $("#deletingText").val()); });
    
    //onclick to complete development need
    $('#submit-completed-status-note').click(function(){ 
    	editDevelopmentNeedProgressOnDB(ADLoginID, $("#complete-id").text(), $("#complete-status").text(), $("#completedTitle").text(), $('#completedText').val()); 
    });
}
...
function addDevelopmentNeedToDB(userID, devNeedTitle, devNeedText, devNeedCategory, devNeedDate){
	var success = function(response){
		...
		var Id = response.developmentNeedID;
...
function deleteDevelopmentNeed(userID, devNeedID, devNeedTitle, deletingText){
	var  success =  function(response){
        ...
        var text = (deletingText ==="") ? ADfullName+ " has deleted Development Need '"+ devNeedTitle +"'." : ADfullName+ " has deleted Development Need '"+ devNeedTitle +"'. "+" A comment was added: '"+ deletingText+"'";
        var d = new Date();
      	var date = moment(d).format('DD MMM YYYY HH:mm');
      	var classDate = moment(d).format('YYYY-MM-DD');
        addNoteToList(id, "Auto Generated", text, date, classDate, emptyArray, emptyArray);
...
function editDevNeedArchiveOnDB(devNeedID, archive){
    ...
    toggleDevNeedArchiveAction(userId, devNeedID, success, error);
}
