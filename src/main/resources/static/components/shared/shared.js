  ...
  $.ajax({
      ...
      success: function(data){
          ...
          $.each(data, function(key, val){
        	  ...
        	  addObjectivesToListPrint(val.timeToCompleteBy, val.title, val.description, val.progress, val.timeStamp, val.proposedBy);
    ...
    $.ajax({
        ...
        success: function(data){
            ...
            $.each(data, function(key, val){
                ...
                addFeedbacksToListPrint(val.providerEmail, val.providerName, val.feedbackDescription, val.timeStamp);
	    ...
	    success: function(data){
	        ...
	        $.each(data, function(key, val){
	        	var expectedBy = (isOngoing(val.timeToCompleteBy) ? val.timeToCompleteBy : formatDate(val.timeToCompleteBy) );
	        	 addDevelopmentNeedsToListPrint(val.timeToCompleteBy, val.title, val.description, val.progress, val.timeStamp, val.category);
...
function getNotesList(){
    ...
    success: function(data){
	         ...
	         $.each(data, function(key, val){
	        	 addNotesToListPrint(val.providerName, val.noteDescription, val.timestamp);
	         }); 
	         openPDF("notesTable");
     },
     error: function(XMLHttpRequest, textStatus, errorThrown){
...
function addObjectivesToListPrint(expectedBy, title, description, progress, createdOn, proposedBy){
...
function addFeedbacksToListPrint(providerEmail, providerName, feedbackDescription, timeStamp){
...
function addDevelopmentNeedsToListPrint(expectedBy, title, description, progress, createdOn, category){
...
function addNotesToListPrint(providerName, noteDescription, timestamp){
